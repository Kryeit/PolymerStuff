...
public class DiscsGUI extends PaginatedGUI {
    ...
    public DiscsGUI(ServerPlayerEntity player) {
        ...
        // Add Rats discs
//        addDisc(ModItems.DISC_RATS_1, "RatInATopHat's Disc 1");
//        addDisc(ModItems.DISC_RATS_2, "RatInATopHat's Disc 2");
//        addDisc(ModItems.DISC_RATS_3, "RatInATopHat's Disc 3");
//
//        // Add Rhino discs
...
//
//        // Add Tess discs
//        addDisc(ModItems.DISC_TESS_1, "__Tesseract's Disc 1");
//        addDisc(ModItems.DISC_TESS_2, "__Tesseract's Disc 2");
//        addDisc(ModItems.DISC_TESS_3, "__Tesseract's Disc 3");
